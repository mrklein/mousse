...
public:
  ...
  // Member Functions
    ...
    const word phase3Name() const { return phase3Name_; }
    ...
    const viscosityModel& nuModel3() const { return nuModel3_(); }
