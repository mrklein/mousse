...
public:
  ...
  // Constructors
    ...
    {
      return tmp<fvPatchField<Type>>{new genericFvPatchField<Type>{*this}};
    }
    ...
    {
      return tmp<fvPatchField<Type>>{new genericFvPatchField<Type>{*this, iF}};
    }
  // Member functions
    // Mapping functions
...
#include "generic_fv_patch_field.ipp"
