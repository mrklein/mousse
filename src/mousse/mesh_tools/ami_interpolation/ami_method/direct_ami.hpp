#ifndef MESH_TOOLS_AMI_INTERPOLATION_AMI_INTERPOLATION_AMI_METHOD_DIRECT_AMI_DIRECT_AMI_HPP_
#define MESH_TOOLS_AMI_INTERPOLATION_AMI_INTERPOLATION_AMI_METHOD_DIRECT_AMI_DIRECT_AMI_HPP_
