...
mousse::word
mousse::AMIInterpolation<SourcePatch, TargetPatch>::interpolationMethodToWord
(
...
mousse::AMIInterpolation<SourcePatch, TargetPatch>::interpolateToSource
(
...
template<class Type, class CombineOp>
mousse::tmp<mousse::Field<Type>>
mousse::AMIInterpolation<SourcePatch, TargetPatch>::interpolateToTarget
(
  const Field<Type>& fld,
  const CombineOp& cop,
  const UList<Type>& defaultValues
