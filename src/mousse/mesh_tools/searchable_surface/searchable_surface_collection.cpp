...
#include "searchable_surface_collection.hpp"
...
void mousse::searchableSurfaceCollection::findLine
(
...
void mousse::searchableSurfaceCollection::findLineAny
(
  const pointField& start,
  const pointField& end,
  List<pointIndexHit>& info
...
void mousse::searchableSurfaceCollection::findLineAll
(
  const pointField& start,
  const pointField& end,
...
void mousse::searchableSurfaceCollection::getRegion
(
  const List<pointIndexHit>& info,
  labelList& region
) const
...
void mousse::searchableSurfaceCollection::getNormal
(
  const List<pointIndexHit>& info,
  vectorField& normal
) const
...
void mousse::searchableSurfaceCollection::distribute
(
...
void mousse::searchableSurfaceCollection::getField
(
  const List<pointIndexHit>& info,
  labelList& values
) const
