#ifndef FINITE_VOLUME_FIELDS_FV_PATCH_FIELDS_DERIVED_MAPPED_FIXED_PUSHED_INTERNAL_VALUE_FV_PATCH_FIELD_HPP_
#define FINITE_VOLUME_FIELDS_FV_PATCH_FIELDS_DERIVED_MAPPED_FIXED_PUSHED_INTERNAL_VALUE_FV_PATCH_FIELD_HPP_
...
public:
  ...
  // Constructors
    ...
    virtual tmp<fvPatchField<Type>> clone() const
    {
      ...
      {
        new mappedFixedPushedInternalValueFvPatchField<Type>{*this}
      };
    }
    ...
    ) const
    {
      return tmp<fvPatchField<Type>>
      {
        new mappedFixedPushedInternalValueFvPatchField<Type>{*this, iF}
      };
    }
  // Member functions
...
#include "mapped_fixed_pushed_internal_value_fv_patch_field.ipp"
