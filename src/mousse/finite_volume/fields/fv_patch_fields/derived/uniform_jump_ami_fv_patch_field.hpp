#ifndef FINITE_VOLUME_FIELDS_FV_PATCH_FIELDS_DERIVED_UNIFORM_JUMP_AMI_FV_PATCH_FIELD_HPP_
#define FINITE_VOLUME_FIELDS_FV_PATCH_FIELDS_DERIVED_UNIFORM_JUMP_AMI_FV_PATCH_FIELD_HPP_
...
#include "uniform_jump_ami_fv_patch_field.ipp"
