...
template<class Type>
bool mousse::SolverPerformance<Type>::checkSingularity
(
  const Type& wApA
)
{
...
template<class Type>
bool mousse::SolverPerformance<Type>::singular() const
{
  for(direction cmpt=0; cmpt<pTraits<Type>::nComponents; cmpt++) {
...
template<class Type>
bool mousse::SolverPerformance<Type>::checkConvergence
(
...
template<class Type>
void mousse::SolverPerformance<Type>::print
(
  Ostream& os
) const
{
...
template<class Type>
bool mousse::SolverPerformance<Type>::operator!=
(
...
template<class Type>
typename mousse::SolverPerformance<Type> mousse::max
(
  const typename mousse::SolverPerformance<Type>& sp1,
  const typename mousse::SolverPerformance<Type>& sp2
)
{
...
(
  Istream& is,
  typename mousse::SolverPerformance<Type>& sp
)
{
...
(
  Ostream& os,
  const typename mousse::SolverPerformance<Type>& sp
)
{
  os << token::BEGIN_LIST
