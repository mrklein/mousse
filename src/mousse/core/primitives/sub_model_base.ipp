...
// Member Functions 
template<class Type>
Type mousse::subModelBase::getBaseProperty
(
...
template<class Type>
void mousse::subModelBase::getBaseProperty
(
  const word& entryName,
  Type& value
) const
...
template<class Type>
void mousse::subModelBase::setBaseProperty
(
  const word& entryName,
  const Type& value
)
...
template<class Type>
void mousse::subModelBase::getModelProperty
(
  const word& entryName,
  Type& value
) const
...
template<class Type>
Type mousse::subModelBase::getModelProperty
(
  const word& entryName,
  const Type& defaultValue
) const
...
template<class Type>
void mousse::subModelBase::setModelProperty
(
  const word& entryName,
  const Type& value
)
