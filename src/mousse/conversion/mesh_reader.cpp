...
// Static Data Members
const mousse::cellModel* mousse::meshReader::unknownModel =
  mousse::cellModeller::lookup("unknown");
const mousse::cellModel* mousse::meshReader::tetModel =
  mousse::cellModeller::lookup("tet");
const mousse::cellModel* mousse::meshReader::pyrModel =
  mousse::cellModeller::lookup("pyr");
const mousse::cellModel* mousse::meshReader::prismModel =
  mousse::cellModeller::lookup("prism");
const mousse::cellModel* mousse::meshReader::hexModel =
  mousse::cellModeller::lookup("hex");
...
void mousse::meshReader::addFaceZones(polyMesh& mesh) const
{
  ...
  nZone = 0;
  for (HashTable<List<label>, word, string::hash>::const_iterator iter =
         monitoringSets_.begin();
