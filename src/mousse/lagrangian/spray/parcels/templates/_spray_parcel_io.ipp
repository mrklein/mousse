...
const std::size_t mousse::SprayParcel<ParcelType>::sizeofFields_
{
...
void mousse::SprayParcel<ParcelType>::readFields(CloudType& c)
{
  if (!c.size()) {
    return;
  }
...
void mousse::SprayParcel<ParcelType>::readFields
(
  CloudType& c,
...
template<class ParcelType>
template<class CloudType>
void mousse::SprayParcel<ParcelType>::writeFields(const CloudType& c)
{
...
template<class ParcelType>
template<class CloudType, class CompositionType>
void mousse::SprayParcel<ParcelType>::writeFields
(
  const CloudType& c,
  const CompositionType& compModel
)
