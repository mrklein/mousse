...
mousse::ReactingMultiphaseLookupTableInjection<CloudType>::
...
// Member Functions 
template<class CloudType>
void mousse::ReactingMultiphaseLookupTableInjection<CloudType>::updateMesh()
{
  // Set/cache the injector cells
  FOR_ALL(injectors_, i) {
...
template<class CloudType>
mousse::scalar
mousse::ReactingMultiphaseLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
mousse::label
mousse::ReactingMultiphaseLookupTableInjection<CloudType>::parcelsToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
mousse::scalar
mousse::ReactingMultiphaseLookupTableInjection<CloudType>::volumeToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
void mousse::ReactingMultiphaseLookupTableInjection<CloudType>::setPositionAndCell
(
  const label parcelI,
...
template<class CloudType>
void mousse::ReactingMultiphaseLookupTableInjection<CloudType>::setProperties
(
  const label parcelI,
  const label nParcels,
  const scalar,
...
template<class CloudType>
bool
mousse::ReactingMultiphaseLookupTableInjection<CloudType>::fullyDescribed() const
{
  return true;
}
...
template<class CloudType>
bool mousse::ReactingMultiphaseLookupTableInjection<CloudType>::validInjection
(
  const label
)
{
