...
bool mousse::InjectionModel<CloudType>::prepareForNextTimeStep
(
  const scalar time,
  label& newParcels,
...
)
{
  ...
  newVolumeFraction =
    this->volumeToInject(t0, t1)/(volumeTotal_ + ROOTVSMALL);
...
template<class CloudType>
bool mousse::InjectionModel<CloudType>::findCellAtPosition
(
  label& cellI,
  label& tetFaceI,
  label& tetPtI,
...
template<class CloudType>
mousse::scalar mousse::InjectionModel<CloudType>::setNumberOfParticles
(
  const label parcels,
...
template<class CloudType>
void mousse::InjectionModel<CloudType>::postInjectCheck
(
...
// Constructors 
template<class CloudType>
mousse::InjectionModel<CloudType>::InjectionModel(CloudType& owner)
:
  ...
  parcelsAddedTotal_
  {
    this->template getModelProperty<label>("parcelsAddedTotal")
  },
...
// Member Functions 
template<class CloudType>
void mousse::InjectionModel<CloudType>::updateMesh()
{
  // do nothing
}
...
template<class CloudType>
mousse::scalar mousse::InjectionModel<CloudType>::averageParcelMass()
{
  label nTotal = 0.0;
...
void mousse::InjectionModel<CloudType>::inject(TrackData& td)
{
  if (!this->active()) {
    return;
  }
...
template<class CloudType>
void mousse::InjectionModel<CloudType>::info(Ostream& os)
{
...
#include "_injection_model_new.ipp"
