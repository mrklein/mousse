...
void mousse::ConeNozzleInjection<CloudType>::setInjectionMethod()
{
...
template<class CloudType>
void mousse::ConeNozzleInjection<CloudType>::setFlowType()
{
...
// Member Functions 
template<class CloudType>
void mousse::ConeNozzleInjection<CloudType>::updateMesh()
{
...
template<class CloudType>
mousse::scalar mousse::ConeNozzleInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
mousse::label mousse::ConeNozzleInjection<CloudType>::parcelsToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
mousse::scalar mousse::ConeNozzleInjection<CloudType>::volumeToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
bool mousse::ConeNozzleInjection<CloudType>::fullyDescribed() const
{
  return false;
}
...
template<class CloudType>
bool mousse::ConeNozzleInjection<CloudType>::validInjection(const label)
{
  return true;
}
