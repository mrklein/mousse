...
const mousse::label mousse::ReactingMultiphaseParcel<ParcelType>::GAS(0);

template<class ParcelType>
const mousse::label mousse::ReactingMultiphaseParcel<ParcelType>::LIQ(1);

template<class ParcelType>
const mousse::label mousse::ReactingMultiphaseParcel<ParcelType>::SLD(2);


//  Private Member Functions
template<class ParcelType>
template<class TrackData>
mousse::scalar mousse::ReactingMultiphaseParcel<ParcelType>::CpEff
(
  TrackData& td,
  const scalar p,
  const scalar T,
...
template<class ParcelType>
template<class TrackData>
mousse::scalar mousse::ReactingMultiphaseParcel<ParcelType>::HsEff
(
  TrackData& td,
  const scalar p,
  const scalar T,
...
template<class ParcelType>
template<class TrackData>
mousse::scalar mousse::ReactingMultiphaseParcel<ParcelType>::LEff
(
  TrackData& td,
  const scalar p,
  const scalar T,
...
template<class ParcelType>
mousse::scalar mousse::ReactingMultiphaseParcel<ParcelType>::updateMassFractions
(
  const scalar mass0,
...
)
{
  ...
  scalar massGas = this->updateMassFraction(mass0*YMix[GAS], dMassGas, YGas_);
  scalar massLiquid =
...
template<class ParcelType>
template<class TrackData>
void mousse::ReactingMultiphaseParcel<ParcelType>::setCellValues
(
  TrackData& td,
  const scalar dt,
  const label cellI
...
template<class ParcelType>
template<class TrackData>
void mousse::ReactingMultiphaseParcel<ParcelType>::cellValueSourceCorrection
(
  TrackData& td,
  const scalar dt,
  const label cellI
...
template<class ParcelType>
template<class TrackData>
void mousse::ReactingMultiphaseParcel<ParcelType>::calc
(
  TrackData& td,
  const scalar dt,
  const label cellI
...
template<class ParcelType>
template<class TrackData>
void mousse::ReactingMultiphaseParcel<ParcelType>::calcDevolatilisation
(
  TrackData& td,
  const scalar dt,
  const scalar age,
...
) const
{
  ...
  if (td.cloud().heatTransfer().BirdCorrection()) {
    ...
    const scalar Wc = max(SMALL, this->rhoc_*RR*this->Tc_/this->pc_);
...
template<class ParcelType>
template<class TrackData>
void mousse::ReactingMultiphaseParcel<ParcelType>::calcSurfaceReactions
(
  TrackData& td,
  const scalar dt,
  const label cellI,
...
// IOStream operators 
#include "_reacting_multiphase_parcel_io.ipp"
