#ifndef THERMOPHYSICAL_MODELS_REACTION_THERMO_CHEMISTRY_READERS_FOAM_CHEMISTRY_READER_HPP_
#define THERMOPHYSICAL_MODELS_REACTION_THERMO_CHEMISTRY_READERS_FOAM_CHEMISTRY_READER_HPP_
