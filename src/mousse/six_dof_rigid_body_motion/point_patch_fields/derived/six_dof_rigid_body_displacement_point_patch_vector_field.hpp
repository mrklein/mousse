...
public:
  ...
  TYPE_NAME("sixDoFRigidBodyDisplacement");
  // Constructors
    ...
    virtual autoPtr<pointPatchField<vector>> clone() const
    {
      return
        ...
        {
          new sixDoFRigidBodyDisplacementPointPatchVectorField{*this}
        };
    }
    ...
    ) const
    {
      return
        autoPtr<pointPatchField<vector>>
        {
          new sixDoFRigidBodyDisplacementPointPatchVectorField{*this, iF}
        };
    }
  // Member functions
    // Mapping functions
