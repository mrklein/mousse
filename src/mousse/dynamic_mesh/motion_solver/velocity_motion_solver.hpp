...
public:
  ...
  // Constructors
    ...
    velocityMotionSolver(const polyMesh&, const IOdictionary&, const word& type);
  ...
  // Member Functions
    ...
    pointVectorField& pointMotionU() { return pointMotionU_; }
    //- Return const reference to the point motion velocity field
    const pointVectorField& pointMotionU() const { return pointMotionU_; }
