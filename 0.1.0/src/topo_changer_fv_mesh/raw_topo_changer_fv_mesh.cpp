...
bool mousse::rawTopoChangerFvMesh::update()
{
  ...
  Info << "rawTopoChangerFvMesh : Checking for topology changes..." << endl;
  ...
  if (hasChanged) {
    Info<< "rawTopoChangerFvMesh : Done topology changes..." << endl;
    ...
    Info << "rawTopoChangerFvMesh : zeroing unmapped boundary values." << endl;
    ...
    if (topoChangeMap().hasMotionPoints()) {
      ...
      Info << "rawTopoChangerFvMesh : calling modifyMotionPoints." << endl;
      topoChanger_.modifyMotionPoints(newPoints);
      // Actually move points
      Info << "rawTopoChangerFvMesh : calling movePoints." << endl;
