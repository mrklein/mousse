...
)
{
  ...
  if (chemistryDict.isDict("chemistryType")) {
    const dictionary&
      chemistryTypeDict{chemistryDict.subDict("chemistryType")};
    ...
    if (thermoDict.isDict("thermoType")) {
      ...
      thermoTypeName = word(thermoTypeDict.lookup("transport")) + '<'
    ...
    chemistryTypeName = word(chemistryTypeDict.lookup("chemistrySolver")) + '<'
