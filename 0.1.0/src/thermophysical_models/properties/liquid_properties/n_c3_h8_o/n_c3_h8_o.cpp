...
#include "n_c3_h8_o.hpp"
#include "add_to_run_time_selection_table.hpp"
// Static Data Members
namespace mousse
{
  DEFINE_TYPE_NAME_AND_DEBUG(nC3H8O, 0);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, nC3H8O,);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, nC3H8O, Istream);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, nC3H8O, dictionary);
}
// Constructors 
mousse::nC3H8O::nC3H8O()
:
  liquidProperties
  (
    60.096,
...
{}
mousse::nC3H8O::nC3H8O(Istream& is)
:
  liquidProperties(is),
  rho_(is),
  pv_(is),
  ...
  D_(is)
{}
mousse::nC3H8O::nC3H8O(const dictionary& dict)
:
  ...
  D_(dict.subDict("D"))
{}
mousse::nC3H8O::nC3H8O(const nC3H8O& liq)
:
