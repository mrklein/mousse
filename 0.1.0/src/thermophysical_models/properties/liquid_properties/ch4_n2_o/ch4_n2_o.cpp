...
#include "ch4_n2_o.hpp"
#include "add_to_run_time_selection_table.hpp"
// Static Data Members
namespace mousse
{
  DEFINE_TYPE_NAME_AND_DEBUG(CH4N2O, 0);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, CH4N2O,);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, CH4N2O, Istream);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, CH4N2O, dictionary);
}
// Constructors 
mousse::CH4N2O::CH4N2O()
:
  liquidProperties
  (
    60.056,
...
{}
mousse::CH4N2O::CH4N2O(Istream& is)
:
  liquidProperties(is),
  rho_(is),
  pv_(is),
  ...
  D_(is)
{}
mousse::CH4N2O::CH4N2O(const dictionary& dict)
:
  ...
  D_(dict.subDict("D"))
{}
mousse::CH4N2O::CH4N2O(const CH4N2O& liq)
:
