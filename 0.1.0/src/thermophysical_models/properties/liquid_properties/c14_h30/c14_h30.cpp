...
namespace mousse
{
  DEFINE_TYPE_NAME_AND_DEBUG(C14H30, 0);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, C14H30,);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, C14H30, Istream);
  ADD_TO_RUN_TIME_SELECTION_TABLE(liquidProperties, C14H30, dictionary);
}
// Constructors 
mousse::C14H30::C14H30()
:
  liquidProperties
  (
    198.392,
...
{}
mousse::C14H30::C14H30(Istream& is)
:
  liquidProperties(is),
  rho_(is),
  pv_(is),
  ...
  D_(is)
{}
mousse::C14H30::C14H30(const dictionary& dict)
:
  ...
  D_(dict.subDict("D"))
{}
mousse::C14H30::C14H30(const C14H30& liq)
:
