#ifndef DYNAMIC_MESH_POLY_TOPO_CHANGE_POLY_TOPO_CHANGE_REFINEMENT_DISTANCE_DATA_HPP_
#define DYNAMIC_MESH_POLY_TOPO_CHANGE_POLY_TOPO_CHANGE_REFINEMENT_DISTANCE_DATA_HPP_
...
public:
  ...
  // Member Functions
    // Access
      inline scalar level0Size() const { return level0Size_; }
      inline scalar& level0Size() { return level0Size_; }
      inline const point& origin() const { return origin_; }
      inline point& origin() { return origin_; }
      inline label originLevel() const { return originLevel_; }
      inline label& originLevel() { return originLevel_; }
    // Other
...
template<> inline bool contiguous<refinementDistanceData>() { return true; }
