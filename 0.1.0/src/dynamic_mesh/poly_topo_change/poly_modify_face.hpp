#ifndef DYNAMIC_MESH_POLY_TOPO_CHANGE_POLY_TOPO_CHANGE_MODIFY_OBJECT_POLY_MODIFY_FACE_HPP_
#define DYNAMIC_MESH_POLY_TOPO_CHANGE_POLY_TOPO_CHANGE_MODIFY_OBJECT_POLY_MODIFY_FACE_HPP_
...
public:
  ...
  // Member Functions
    //- Return face
    const face& newFace() const { return face_; }
    //- Return master face ID
    label faceID() const { return faceID_; }
    //- Return owner cell ID
    label owner() const { return owner_; }
    //- Return owner cell ID
    label neighbour() const { return neighbour_; }
    //- Does the face flux need to be flipped
    bool flipFaceFlux() const { return flipFaceFlux_; }
    //- Does the face belong to a boundary patch?
    bool isInPatch() const { return patchID_ >= 0; }
    //- Boundary patch ID
    ...
    //- Face zone flip
    label zoneFlip() const { return zoneFlip_; }
};
