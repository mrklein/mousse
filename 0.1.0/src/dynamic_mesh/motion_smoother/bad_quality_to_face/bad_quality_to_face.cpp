...
namespace mousse
{
DEFINE_TYPE_NAME_AND_DEBUG(badQualityToFace, 0);
ADD_TO_RUN_TIME_SELECTION_TABLE(topoSetSource, badQualityToFace, word);
ADD_TO_RUN_TIME_SELECTION_TABLE(topoSetSource, badQualityToFace, istream);
}
