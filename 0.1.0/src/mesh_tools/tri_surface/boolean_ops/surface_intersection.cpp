...
bool mousse::surfaceIntersection::excludeEdgeHit
(
...
//// - edgeI
//// - intersection point
//mousse::pointIndexHit mousse::surfaceIntersection::faceEdgeIntersection
//(
//    const triSurface& surf,
...
//    return pInter;
//}
void mousse::surfaceIntersection::storeIntersection
(
...
// surface2 reversed.
void mousse::surfaceIntersection::classifyHit
(
...
//
void mousse::surfaceIntersection::doCutEdges
(
  const triSurface& surf1,
...
// Constructors 
// Null constructor
mousse::surfaceIntersection::surfaceIntersection()
:
  cutPoints_(0),
  cutEdges_(0),
  facePairToVertex_(0),
...
// Member Functions 
const mousse::pointField& mousse::surfaceIntersection::cutPoints() const
{
  return cutPoints_;
}
const mousse::edgeList& mousse::surfaceIntersection::cutEdges() const
{
  return cutEdges_;
}
const mousse::labelPairLookup& mousse::surfaceIntersection::facePairToVertex() const
{
  return facePairToVertex_;
}
const mousse::labelPairLookup& mousse::surfaceIntersection::facePairToEdge() const
{
  return facePairToEdge_;
}
const mousse::labelListList& mousse::surfaceIntersection::edgeCuts
(
  const bool isFirstSurf
) const
{
...
const mousse::labelListList& mousse::surfaceIntersection::surf1EdgeCuts() const
{
  return surf1EdgeCuts_;
}
const mousse::labelListList& mousse::surfaceIntersection::surf2EdgeCuts() const
{
  return surf2EdgeCuts_;
}
