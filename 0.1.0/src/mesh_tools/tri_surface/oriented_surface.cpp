...
mousse::labelList mousse::orientedSurface::faceToEdge
(
  const triSurface& s,
...
mousse::labelList mousse::orientedSurface::edgeToFace
(
  const triSurface& s,
...
void mousse::orientedSurface::walkSurface
(
  const triSurface& s,
...
void mousse::orientedSurface::propagateOrientation
(
  const triSurface& s,
...
void mousse::orientedSurface::findZoneSide
(
...
bool mousse::orientedSurface::flipSurface
(
  triSurface& s,
...
bool mousse::orientedSurface::orientConsistent(triSurface& s)
{
...
// Null constructor
mousse::orientedSurface::orientedSurface()
:
  triSurface{}
{}
...
// Member Functions 
bool mousse::orientedSurface::orient
(
  triSurface& s,
  const point& samplePoint,
  const bool orientOutside
