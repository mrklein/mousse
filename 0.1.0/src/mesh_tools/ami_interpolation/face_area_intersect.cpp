...
const mousse::NamedEnum<mousse::faceAreaIntersect::triangulationMode, 2>
  mousse::faceAreaIntersect::triangulationModeNames_;

mousse::scalar mousse::faceAreaIntersect::tol = 1e-6;


// Private Member Functions 
void mousse::faceAreaIntersect::triSliceWithPlane
(
  const triPoints& tri,
  const plane& p,
...
mousse::scalar mousse::faceAreaIntersect::triangleIntersect
(
  const triPoints& src,
  const triPoints& tgt,
  const vector& n
...
// Constructors 
mousse::faceAreaIntersect::faceAreaIntersect
(
