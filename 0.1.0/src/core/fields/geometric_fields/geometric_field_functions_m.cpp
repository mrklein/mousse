...
{                                                                             \
  mousse::Func(res.internalField(), gf1.internalField());                     \
  mousse::Func(res.boundaryField(), gf1.boundaryField());                     \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
...
{                                                                             \
  mousse::OpFunc(res.internalField(), gf1.internalField());                   \
  mousse::OpFunc(res.boundaryField(), gf1.boundaryField());                   \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
...
{                                                                             \
  mousse::Func(res.internalField(), gf1.internalField(), gf2.internalField());\
  mousse::Func(res.boundaryField(), gf1.boundaryField(), gf2.boundaryField());\
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> Func                     \
...
{                                                                             \
  mousse::Func(res.internalField(), dt1.value(), gf2.internalField());        \
  mousse::Func(res.boundaryField(), dt1.value(), gf2.boundaryField());        \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> Func                     \
...
{                                                                             \
  mousse::Func(res.internalField(), gf1.internalField(), dt2.value());        \
  mousse::Func(res.boundaryField(), gf1.boundaryField(), dt2.value());        \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> Func                     \
...
{                                                                             \
  mousse::OpFunc(res.internalField(), dt1.value(), gf2.internalField());      \
  mousse::OpFunc(res.boundaryField(), dt1.value(), gf2.boundaryField());      \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> operator Op              \
...
{                                                                             \
  mousse::OpFunc(res.internalField(), gf1.internalField(), dt2.value());      \
  mousse::OpFunc(res.boundaryField(), gf1.boundaryField(), dt2.value());      \
}                                                                             \
                                                                              \
TEMPLATE                                                                      \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> operator Op              \
