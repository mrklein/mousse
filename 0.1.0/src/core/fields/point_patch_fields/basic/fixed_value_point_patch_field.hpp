#ifndef CORE_FIELDS_POINT_PATCH_FIELDS_BASIC_FIXED_VALUE_POINT_PATCH_FIELD_HPP_
#define CORE_FIELDS_POINT_PATCH_FIELDS_BASIC_FIXED_VALUE_POINT_PATCH_FIELD_HPP_
