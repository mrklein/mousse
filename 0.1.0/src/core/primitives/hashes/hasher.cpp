...
#include "hasher.hpp"
#include "hasher_int.hpp"
#if defined (__GLIBC__)
#  include <endian.h>
#endif

// Left-rotate a 32-bit value and carry by nBits
#define BIT_ROTATE_LEFT(x, nBits)  (((x) << (nBits)) | ((x) >> (32 - (nBits))))
