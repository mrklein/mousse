...
inline uint32_t mousse::SHA1::swapBytes(uint32_t n)
{
  #ifdef __BYTE_ORDER
...
inline void mousse::SHA1::set_uint32(unsigned char *cp, uint32_t v)
{
  memcpy(cp, &v, sizeof(uint32_t));
}
// Private Member Functions
void mousse::SHA1::processBytes(const void *data, size_t len)
{
...
void mousse::SHA1::processBlock(const void *data, size_t len)
{
...
void mousse::SHA1::calcDigest(SHA1Digest& dig) const
{
...
mousse::SHA1Digest mousse::SHA1::digest() const
{
  SHA1Digest dig;
  if (finalized_)
  {
