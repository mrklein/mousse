...
mousse::SmoothSolver<Type, DType, LUType>::SmoothSolver
(
...
// Member Functions 
template<class Type, class DType, class LUType>
void mousse::SmoothSolver<Type, DType, LUType>::readControls()
{
...
mousse::SmoothSolver<Type, DType, LUType>::solve(Field<Type>& psi) const
{
