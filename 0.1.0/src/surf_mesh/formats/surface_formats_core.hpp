#ifndef SURF_MESH_SURFACE_FORMATS_SURFACE_FORMATS_CORE_HPP_
#define SURF_MESH_SURFACE_FORMATS_SURFACE_FORMATS_CORE_HPP_
...
protected:
    ...
    {
      return {1, surfZone(name, container.size(), 0, 0)};
    }
