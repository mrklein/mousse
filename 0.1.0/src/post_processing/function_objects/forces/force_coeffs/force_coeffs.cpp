...
// Constructors 
mousse::forceCoeffs::forceCoeffs
(
  const word& name,
...
{}
// Member Functions 
void mousse::forceCoeffs::read(const dictionary& dict)
{
  if (active_)
  {
    forces::read(dict);
...
void mousse::forceCoeffs::execute()
{
  // Do nothing - only valid on write
}
void mousse::forceCoeffs::end()
{
  // Do nothing - only valid on write
}
void mousse::forceCoeffs::timeSet()
{
  // Do nothing - only valid on write
}
void mousse::forceCoeffs::write()
{
