...
//void mousse::meshRefinement::getCoupledRegionMaster
//(
...
//
//
//void mousse::meshRefinement::calcLocalRegions
//(
//    const globalIndex& globalCells,
...
//
//
//mousse::label mousse::meshRefinement::getShiftedRegion
//(
...
//void mousse::meshRefinement::addUnique(const label elem, labelList& lst)
//{
...
//
//
//void mousse::meshRefinement::calcRegionRegions
//(
//    const labelList& globalRegion,
//    const Map<label>& globalToLocalRegion,
//    const Map<label>& coupledRegionToMaster,
...
//mousse::labelList mousse::meshRefinement::decomposeCombineRegions
//(
//    const scalarField& cellWeights,
//    const boolList& blockedFace,
