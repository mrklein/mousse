...
:
  ...
  alphaK1_
  {
    dimensioned<scalar>::lookupOrAddToDict("alphaK1", this->coeffDict_, 0.85)
  },
  alphaK2_
  {
    dimensioned<scalar>::lookupOrAddToDict("alphaK2", this->coeffDict_, 1.0)
  },
  alphaOmega1_
  {
