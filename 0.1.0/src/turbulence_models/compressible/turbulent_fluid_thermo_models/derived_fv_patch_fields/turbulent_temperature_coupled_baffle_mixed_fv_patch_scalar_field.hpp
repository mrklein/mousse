...
#ifndef turbulent_temperature_coupled_baffle_mixed_fv_patch_scalar_field_hpp_
#define turbulent_temperature_coupled_baffle_mixed_fv_patch_scalar_field_hpp_
