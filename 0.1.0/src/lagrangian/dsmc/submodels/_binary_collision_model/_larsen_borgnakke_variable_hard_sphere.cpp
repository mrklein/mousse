...
mousse::scalar mousse::LarsenBorgnakkeVariableHardSphere<CloudType>::energyRatio
(
  scalar ChiA,
  scalar ChiB
)
...
// Constructors 
template<class CloudType>
mousse::LarsenBorgnakkeVariableHardSphere<CloudType>::
...
// Member Functions 
template<class CloudType>
bool mousse::LarsenBorgnakkeVariableHardSphere<CloudType>::active() const
{
  return true;
}
template<class CloudType>
mousse::scalar mousse::LarsenBorgnakkeVariableHardSphere<CloudType>::sigmaTcR
(
...
template<class CloudType>
void mousse::LarsenBorgnakkeVariableHardSphere<CloudType>::collide
(
