...
mousse::ReitzDiwakar<CloudType>::ReitzDiwakar
(
...
template<class CloudType>
mousse::ReitzDiwakar<CloudType>::ReitzDiwakar(const ReitzDiwakar<CloudType>& bum)
:
...
// Member Functions
template<class CloudType>
bool mousse::ReitzDiwakar<CloudType>::update
(
  const scalar dt,
  const vector& g,
  scalar& d,
