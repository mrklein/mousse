...
mousse::PilchErdman<CloudType>::PilchErdman
(
...
template<class CloudType>
mousse::PilchErdman<CloudType>::PilchErdman(const PilchErdman<CloudType>& bum)
:
...
// Member Functions 
template<class CloudType>
bool mousse::PilchErdman<CloudType>::update
(
  const scalar dt,
  const vector& /*g*/,
  scalar& d,
