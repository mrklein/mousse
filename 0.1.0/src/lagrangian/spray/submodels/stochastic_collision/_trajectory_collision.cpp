...
void mousse::TrajectoryCollision<CloudType>::collide(const scalar dt)
{
  ORourkeCollision<CloudType>::collide(dt);
}
template<class CloudType>
bool mousse::TrajectoryCollision<CloudType>::collideParcels
(
  const scalar dt,
  parcelType& p1,
  parcelType& p2,
...
// Constructors 
template<class CloudType>
mousse::TrajectoryCollision<CloudType>::TrajectoryCollision
(
