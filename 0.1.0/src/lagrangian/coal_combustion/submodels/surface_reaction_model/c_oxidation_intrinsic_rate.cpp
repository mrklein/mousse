...
mousse::COxidationIntrinsicRate<CloudType>::COxidationIntrinsicRate
(
...
// Destructor 
template<class CloudType>
mousse::COxidationIntrinsicRate<CloudType>::
~COxidationIntrinsicRate()
{}
// Member Functions 
template<class CloudType>
mousse::scalar mousse::COxidationIntrinsicRate<CloudType>::calculate
(
  const scalar dt,
  const label cellI,
  const scalar d,
