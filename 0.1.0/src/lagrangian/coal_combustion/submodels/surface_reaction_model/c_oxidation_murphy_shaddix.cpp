...
mousse::label mousse::COxidationMurphyShaddix<CloudType>::maxIters_ = 1000;
template<class CloudType>
mousse::scalar mousse::COxidationMurphyShaddix<CloudType>::tolerance_ = 1e-06;
// Constructors 
template<class CloudType>
mousse::COxidationMurphyShaddix<CloudType>::COxidationMurphyShaddix
(
...
// Member Functions 
template<class CloudType>
mousse::scalar mousse::COxidationMurphyShaddix<CloudType>::calculate
(
  const scalar dt,
  const label cellI,
  const scalar d,
