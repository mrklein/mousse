...
mousse::COxidationDiffusionLimitedRate<CloudType>::COxidationDiffusionLimitedRate
(
...
// Destructor 
template<class CloudType>
mousse::COxidationDiffusionLimitedRate<CloudType>::
...
// Member Functions 
template<class CloudType>
mousse::scalar mousse::COxidationDiffusionLimitedRate<CloudType>::calculate
(
  const scalar dt,
  const label cellI,
  const scalar d,
