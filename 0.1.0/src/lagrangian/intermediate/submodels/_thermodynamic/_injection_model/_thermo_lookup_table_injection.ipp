...
#include "_thermo_lookup_table_injection.hpp"
#include "scalar_io_list.hpp"


// Constructors 
template<class CloudType>
mousse::ThermoLookupTableInjection<CloudType>::ThermoLookupTableInjection
(
...
// Member Functions 
template<class CloudType>
void mousse::ThermoLookupTableInjection<CloudType>::updateMesh()
{
  // Set/cache the injector cells
  FOR_ALL(injectors_, i) {
...
template<class CloudType>
mousse::scalar mousse::ThermoLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
mousse::label mousse::ThermoLookupTableInjection<CloudType>::parcelsToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
mousse::scalar mousse::ThermoLookupTableInjection<CloudType>::volumeToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
void mousse::ThermoLookupTableInjection<CloudType>::setPositionAndCell
(
  const label parcelI,
...
template<class CloudType>
void mousse::ThermoLookupTableInjection<CloudType>::setProperties
(
  const label parcelI,
  const label nParcels,
  const scalar,
...
template<class CloudType>
bool mousse::ThermoLookupTableInjection<CloudType>::fullyDescribed() const
{
  return true;
}
...
template<class CloudType>
bool mousse::ThermoLookupTableInjection<CloudType>::validInjection(const label)
{
  return true;
}
