...
mousse::wordList mousse::ThermoSurfaceFilm<CloudType>::interactionTypeNames_
(
  IStringStream
  (
...
template<class CloudType>
mousse::word mousse::ThermoSurfaceFilm<CloudType>::interactionTypeStr
(
...
template<class CloudType>
mousse::vector mousse::ThermoSurfaceFilm<CloudType>::tangentVector
(
  const vector& v
) const
{
...
template<class CloudType>
mousse::vector mousse::ThermoSurfaceFilm<CloudType>::splashDirection
(
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::absorbInteraction
(
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::bounceInteraction
(
  parcelType& p,
  const polyPatch& pp,
  const label faceI,
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::drySplashInteraction
(
  regionModels::surfaceFilmModels::surfaceFilmModel& filmModel,
  const parcelType& p,
  const polyPatch& pp,
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::wetSplashInteraction
(
  regionModels::surfaceFilmModels::surfaceFilmModel& filmModel,
  parcelType& p,
  const polyPatch& pp,
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::splashInteraction
(
  regionModels::surfaceFilmModels::surfaceFilmModel& filmModel,
  const parcelType& p,
  const polyPatch& pp,
...
// Constructors 
template<class CloudType>
mousse::ThermoSurfaceFilm<CloudType>::ThermoSurfaceFilm
(
...
// Member Functions 
template<class CloudType>
bool mousse::ThermoSurfaceFilm<CloudType>::transferParcel
(
  parcelType& p,
  const polyPatch& pp,
  bool& keepParticle
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::cacheFilmFields
(
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::setParcelProperties
(
  parcelType& p,
...
template<class CloudType>
void mousse::ThermoSurfaceFilm<CloudType>::info(Ostream& os)
{
