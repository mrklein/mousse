#ifndef LAGRANGIAN_INTERMEDIATE_SUBMODELS_TMPPIC_TDAMPING_MODELS_TDAMPING_MODEL_HPP_
#define LAGRANGIAN_INTERMEDIATE_SUBMODELS_TMPPIC_TDAMPING_MODELS_TDAMPING_MODEL_HPP_
