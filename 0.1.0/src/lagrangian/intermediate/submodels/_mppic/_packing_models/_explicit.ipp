...
mousse::PackingModels::Explicit<CloudType>::Explicit
(
...
:
  ...
  correctionLimiting_{cm.correctionLimiting_->clone()}
{}
...
// Member Functions 
template<class CloudType>
void mousse::PackingModels::Explicit<CloudType>::cacheFields(const bool store)
{
...
template<class CloudType>
mousse::vector mousse::PackingModels::Explicit<CloudType>::velocityCorrection
(
