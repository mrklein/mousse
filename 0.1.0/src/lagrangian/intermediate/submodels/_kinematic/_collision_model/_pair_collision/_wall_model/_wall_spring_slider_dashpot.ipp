...
void mousse::WallSpringSliderDashpot<CloudType>::findMinMaxProperties
(
  scalar& rMin,
  scalar& rhoMax,
  scalar& UMagMax
...
template<class CloudType>
void mousse::WallSpringSliderDashpot<CloudType>::evaluateWall
(
...
) const
{
  ...
  vector fN_PW =
    rHat_PW*(kN*pow(normalOverlapMag, b_) - etaN*(U_PW & rHat_PW));
...
// Constructors 
template<class CloudType>
mousse::WallSpringSliderDashpot<CloudType>::WallSpringSliderDashpot
(
...
// Member Functions 
template<class CloudType>
mousse::scalar mousse::WallSpringSliderDashpot<CloudType>::pREff
(
...
template<class CloudType>
bool mousse::WallSpringSliderDashpot<CloudType>::controlsTimestep() const
{
  return true;
}
...
template<class CloudType>
mousse::label mousse::WallSpringSliderDashpot<CloudType>::nSubCycles() const
{
  if (!(this->owner().size())) {
    return 1;
  }
