...
mousse::KinematicLookupTableInjection<CloudType>::KinematicLookupTableInjection
(
...
template<class CloudType>
mousse::scalar mousse::KinematicLookupTableInjection<CloudType>::timeEnd() const
{
  return this->SOI_ + duration_;
}
template<class CloudType>
mousse::label mousse::KinematicLookupTableInjection<CloudType>::parcelsToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
mousse::scalar mousse::KinematicLookupTableInjection<CloudType>::volumeToInject
(
  const scalar time0,
  const scalar time1
)
...
template<class CloudType>
void mousse::KinematicLookupTableInjection<CloudType>::setPositionAndCell
(
  const label parcelI,
...
template<class CloudType>
void mousse::KinematicLookupTableInjection<CloudType>::setProperties
(
  const label parcelI,
  const label nParcels,
  const scalar,
...
template<class CloudType>
bool mousse::KinematicLookupTableInjection<CloudType>::fullyDescribed() const
{
  return true;
}
template<class CloudType>
bool mousse::KinematicLookupTableInjection<CloudType>::validInjection
(
  const label
)
{
