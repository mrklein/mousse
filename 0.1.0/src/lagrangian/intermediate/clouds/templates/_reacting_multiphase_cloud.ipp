...
void mousse::ReactingMultiphaseCloud<CloudType>::setModels()
{
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::cloudReset
(
...
// Constructors 
template<class CloudType>
mousse::ReactingMultiphaseCloud<CloudType>::ReactingMultiphaseCloud
(
...
// Member Functions 
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::setParcelThermoProperties
(
  parcelType& parcel,
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::checkParcelProperties
(
  parcelType& parcel,
  const scalar lagrangianDt,
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::storeState()
{
  cloudCopyPtr_.reset
  (
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::resetSourceTerms()
{
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::evolve()
{
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::autoMap
(
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::info()
{
  CloudType::info();
...
template<class CloudType>
void mousse::ReactingMultiphaseCloud<CloudType>::writeFields() const
{
  if (this->size()) {
