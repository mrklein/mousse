...
// Static Data Members
DEFINE_TYPE_NAME_AND_DEBUG(linearDistance, 0);
ADD_TO_RUN_TIME_SELECTION_TABLE(cellSizeFunction, linearDistance, dictionary);
...
) const
{
  ...
  scalar gradient
    = (distanceCellSize_ - interpolatedSize)/distance_;
