...
// Member Functions 
//
//mousse::scalar mousse::fileControl::cellSize(const point& pt) const
//{
//    scalarList bary;
//    Cell_handle ch;
//
...
//mousse::tensor mousse::fileControl::cellAlignment(const point& pt) const
//{
//    scalarList bary;
//    Cell_handle ch;
//
...
//    label nearest = 0;
//
//    tensor alignment = mousse::tensor::zero;
//    forAll(bary, pI)
//    {
...
//
////- Return the cell alignment at the given location
//void mousse::fileControl::cellSizeAndAlignment
//(
//    const point& pt,
//    scalar& size,
//    tensor& alignment
