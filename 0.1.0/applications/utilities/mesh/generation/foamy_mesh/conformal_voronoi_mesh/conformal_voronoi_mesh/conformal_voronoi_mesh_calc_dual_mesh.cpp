...
//void mousse::conformalVoronoiMesh::smoothSurface
//(
//    pointField& pts,
...
//
//
//mousse::label mousse::conformalVoronoiMesh::smoothSurfaceDualFaces
//(
//    pointField& pts,
//    const labelList& boundaryPts,
//    Map<label>& dualPtIndexMap
...
//        }
    if (!cit->hasFarPoint())
    {
      ...
      if (Pstream::parRun() && cit->parallelDualVertex())
      {
        ...
        pts[cit->cellIndex()] = mousse::point
        (
