...
void mousse::conformalVoronoiMesh::buildSurfaceConformation()
{
  ...
  const label AtoV = label(6/mousse::pow(scalar(number_of_vertices()), 3));
...
//        mousse::point endPt = 0.5*(c1->dual() + c2->dual());
...
//void mousse::conformalVoronoiMesh::reportSurfaceConformationQuality()
//{
...
//        {
//            mousse::point vert(topoint(vit->point()));
//            pointIndexHit surfHit;
//            label hitSurface;
//
//            dualCellLargestSurfaceProtrusion(vit, surfHit, hitSurface);
...
//
//                mousse::point pt = topoint(vit->point());
//
